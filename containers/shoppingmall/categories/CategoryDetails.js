...
import ProductCarousel from '../shoppingmall/ProductSwipe';
import SmallTitle from '../shoppingmall/smallTitle';
import Specifications from '../shoppingmall/Specifications';
		...
		return (
			<View style={{position:'relative',height:'100%'}}>
				<ScrollView style={styles.outView}>
					...
					<ProductCarousel imageArray={this.state.productImgs}/>
				...
				<View style={styles.bottomCart}>
					<ImageButton
						text={'商城'}
						source={require('../../imgs/chanzi.png')}
